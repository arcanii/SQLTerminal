...
|-------|----|-----------|
|1.1.4 | June 14, 2026 | SQL syntax highlighting; persistent searchable query history + snippets; sortable result columns + cell detail (JSON); in-app Help (⌘?); transparent About logo |
